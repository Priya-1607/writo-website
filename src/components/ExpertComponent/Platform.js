...
import "./Platform.css"
//import img from '../assets/mock-interview-9666.png'
import img from './assets/mock-interview-9666.png'
...
const Platform = () => {
  ...
  return (
    <div className='platform_page'>
      <h2 className='text-center sm:text-xl lg:text-3xl font-medium '>A One stop Platform</h2>
      <p className='text-center lg:text-lg lg:m-4 text-gray-500'>Practice and learn till you are perfect</p>

      <ul className='header1 lg:text-base font-semibold m-3 p-5'>
      ...
      <div className={toggleState === 1 ? "content_container grid xl:grid-cols-2 gap-x-40" : "hide"}>
        <div className=' content'>
          <h3 className=' text-xl font-bold content_heading'>Well Guided Program</h3>
          <h1 className='text-2xl font-medium py-4 content_heading2'>We have invented and perfected the best system to learn coding</h1>
          <p className=' text-sm my-2 content_text'>
            ...
            <br />
            <br />
            Very short learning videos: 10-15 minutes

            2-3 Guided Problems & 5-10 practice problems to understand: 45 minutes

            Doubts resolved instantly by our Teaching Assitants and Notes for Revision
          </p>
          <div className='flex flex-row text-sm content_last'>
            ...
            <div className='p-5 w-40'>
              ...
              <p>apractice problems in each course</p>
            </div>
          </div>
        </div>
      ...
      <div className={toggleState === 2 ? "content_container grid xl:grid-cols-2 gap-x-40" : "hide"}>
        <div className=' content'>
          <h3 className=' text-xl font-bold content_heading'>Doubt Resolution</h3>
          <h1 className='text-2xl font-medium py-4 content_heading2'>Get your doubts resolved instantly with live 1:1 mentor support.</h1>
          <p className=' text-sm my-2 content_text'>
          ...
          <div className='flex flex-row text-sm content_last'>
            <div className='py-5'>
              <h1 className='text-3xl font-bold'>100+</h1>
              <p>events conducted <br />every month</p>
            </div>
            <div className='p-5'>
              <h1 className='text-3xl font-bold '>30+</h1>
              <p>articles published <br /> every month</p>
            </div>
          </div>
        </div>
        <div className='grid-cols-4 content-image_container'>
      ...
      <div className={toggleState === 3 ? "content_container grid xl:grid-cols-2 gap-x-40" : "hide"}>
        <div className=' content'>
          <h3 className=' text-xl font-bold content_heading'>Free Resources</h3>
          <h1 className='text-2xl font-medium py-4 content_heading2'>A platform to help you practice, compete & get ready for interviews.</h1>
          <p className=' text-sm my-2 content_text'>
      ...
      <div className={toggleState === 4 ? "content_container grid xl:grid-cols-2 gap-x-40" : "hide"}>
        <div className=' content'>
          <h3 className=' text-xl font-bold content_heading'>Mock Interviews</h3>
          <h1 className='text-2xl font-medium py-4 content_heading2'>Mock Interviews to help you get prepared for your real interview</h1>
          <p className=' text-sm my-2 content_text'>
      ...
      <div className={toggleState === 5 ? "content_container grid xl:grid-cols-2 gap-x-40" : "hide"}>
        <div className=' content'>
          <h3 className=' text-xl font-bold content_heading'>Free Resources</h3>
          <h1 className='text-2xl font-medium py-4 content_heading2'>Placement Cell - A dedicated team to help you land the best opportunities.</h1>
          <p className=' text-sm my-2 content_text'>
      ...
      <div className={toggleState === 6 ? "content_container grid xl:grid-cols-2 gap-x-40" : "hide"}>
        <div className=' content'>
          <h3 className=' text-xl font-bold content_heading'>Free Resources</h3>
          <h1 className='text-2xl font-medium py-4 content_heading2'>Tons of resources to enable you to learn for free & stay up to date</h1>
          <p className=' text-sm my-2 content_text'>
